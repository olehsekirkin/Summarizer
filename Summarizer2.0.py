...
def getNewsData(input, min_articles=10):  # Specify the minimum number of articles to fetch
    headers = {
        "User-Agent":
    ...
    while len(news_results) < min_articles:
        ...
        for el in soup.select("div.SoaBEf"):
            ...
            if summarized_content:  # Only add articles with successful content retrieval
                news_results.append({
                    "Link": link,
        ...
        start_index += 10  # Increment the start index for the next page of results
...
getNewsData("Tesla", min_articles=10)  # Fetch and summarize at least 10 articles, ignoring failed ones, and create PDF
